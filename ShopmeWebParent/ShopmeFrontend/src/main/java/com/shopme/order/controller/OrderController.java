...
import com.shopme.order.OrderConstants;
...
public class OrderController {
    ...
    public String listOrdersByPage(Model model, HttpServletRequest request,
        ...
        long startCount = (pageNum - 1) * OrderConstants.ORDERS_PER_PAGE + 1;
        model.addAttribute("startCount", startCount);

        long endCount = startCount + OrderConstants.ORDERS_PER_PAGE - 1;
